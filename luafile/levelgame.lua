...
function scene:willEnterScene (event)
    ...
    bol         = {
        laser       = false,    mobrun      = false,    carstart    = false,
        masstatus   = nil,      masrun      = false,    bigmas      = nil,
        bigrun      = nil,      fence       = false,    top         = nil,
        top_1       = false,    top_2       = false,    top_3       = false,
        top_4       = false,    top_5       = false,    monmovstats = nil,
        movrun      = false,    human       = false,    human_2     = false,
        fog         = false,    star        = false,    bols        = false,
        bosstats    = false,    bigboss     = false,    bosspause   = false,
        }
    text_       = {
        barrel      = nil,      laser       = nil,      car         = nil,
        monster     = nil,      style       = nil,      master      = nil,
        highscore   = nil,      count       = nil,      bigmaster   = nil,
        level       = nil,
        }
    objects_    = {
        remover_    = nil,      remover     = nil,      pause       = nil,
        carpow      = nil,      barrel      = nil,      beam        = nil,
        left_       = nil,      right_      = nil,      top_        = nil,
        monster     = nil,      pausescreen = nil,      quitbutton  = nil,
        resbutton   = nil,      nextbutton  = nil,      menubutton  = nil,
    ...
    timer_      = {
        ...
        master      = nil,      bigmas      = nil,      star        = nil,
        movmob      = nil,      human       = nil,      human_2     = nil,
        bosstats    = nil,
        }           
    number_     = {
        monster         = 0,        monsterleft     = nil,      flasher         = 0,
        deadmon         = 0,        lasernumber     = 0,        damage          = nil,
        carP            = 0,        laserP          = 0,        barrelP         = 0,
        exnum           = 0,        barrel          = 0,        mobnum          = 0,
        score           = 0,        life            = 3,        carnum          = 0,
        carpow          = 0,        masdamage       = nil,      mobster         = nil,
        highscore       = nil,      bigdamage       = nil,      stotalmon       = nil,
        bigspeed        = nil,      fencelife       = 6,        star            = 0,
        starnum         = 0,        human           = 0,        human_2         = 0,
        coin            = 0,        alien1spd       = 0,        alien2spd       = 0,
        alien3spd       = 0,        stats           = 0,        monsternum      = 0,
        mastermon       = 0,        movnum          = 0,        bignum          = 0,
        bossing         = 0,        bosstatshold    = 0,        monsternumhold  = 0,
        mastermonhold   = 0,        movnumhold      = 0,        bignumhold      = 0,
        bossinghold     = 0,        holder          = 0,
        }
    game_       = {
        pause           = true,     cardir          = nil,      start           = nil,
        killed          = 0,        over            = false,    winner          = false,
        mobspeed        = nil,      masspeed        = nil,      level           = nil,
        stats           = false,    movingobject    = nil,      tutorial        = nil,   
        }
    trans       = {
        top_1   = nil,  top_2   = nil,  top_3   = nil,
        top_4   = nil,  top_5   = nil,  can_1   = nil,
        can_2   = nil,  can_3   = nil,  can_4   = nil,
        can_5   = nil,  timer_1 = nil,  timer_2 = nil,
        timer_3 = nil,  timer_4 = nil,  timer_5 = nil,
        }            
    boss = {
...
function scene:enterScene (event)
    ...
    if backprob.rowid >= 1  and backprob.rowid <= 5 or backprob.rowid >= 21  and backprob.rowid <= 25 then
        objects_.dark = display.newImageRect("background/lateafternoon.png",display.contentWidth+50,display.contentHeight+50)
        
    elseif backprob.rowid >= 6  and backprob.rowid <= 10 or backprob.rowid >= 26  and backprob.rowid <= 30 then  
        objects_.dark = display.newImageRect("background/earlynight.png",display.contentWidth+50,display.contentHeight+50)
        
    elseif backprob.rowid >= 11  and backprob.rowid <= 15 or backprob.rowid >= 31  and backprob.rowid <= 35 then
        objects_.dark = display.newImageRect("background/dark.png",display.contentWidth+50,display.contentHeight+50)
        
    elseif backprob.rowid >= 16  and backprob.rowid <= 20 or backprob.rowid >= 26  and backprob.rowid <= 40 then
        objects_.dark = display.newImageRect("background/dark.png",display.contentWidth+50,display.contentHeight+50)
        
        objects_.fog_1 = display.newImageRect("background/fn-leftfog.png",display.contentWidth+50,display.contentHeight+50)
        ...
        objects_.fog_2 = display.newImageRect("background/fn-rightfog.png",display.contentWidth+50,display.contentHeight+50)
    ...
    local function showobjects (event)
        ...
        text_.score:setReferencePoint(display.CenterLeftReferencePoint);
        text_.score.x = w_ - 300;  
        text_.score.y = text_.level.y + text_.score.height;    
