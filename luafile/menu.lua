    ...
    buttons.aboutbutton = external.widget.newButton
    {
        ...
        onRelease   = function (event)
            ...
            if event.phase == "ended" and timertrans == false then
                ...
                texting.y = scroller.height + texting.height
                    timerstop = transition.to(texting,{time = 5000,y = 0,alpha = 0.9,onComplete = aboutustop})
                timertrans = true   
...
--                                            end
--                                        
--                                            native.showAlert( "Error", "To develop for Facebook Connect, you need an App ID from Facebook.", { "Learn More" }, onComplete )
--                                        end
